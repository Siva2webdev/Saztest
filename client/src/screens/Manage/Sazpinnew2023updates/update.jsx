...
const Update8 = () => {
  ...
  const [sazpinNew2023Updates, setSazpinNew2023Updates] = useState([]);
  useEffect(() => {
    fetch("http://localhost:5001/api/masa_new_ver_app_updates/find")
      .then((response) => response.json())
      .then((json) => setSazpinNew2023Updates(json.data));
  }, []);
  console.log(sazpinNew2023Updates);
