...
const Update12 = () => {
  ...
  const [multiverappupdates, setmultiverappupdates] = useState([]);
  useEffect(() => {
    fetch("http://localhost:5001/api/multi_ver_app_updates/find")
      .then((response) => response.json())
      .then((json) => setmultiverappupdates(json.data));
  }, []);
  console.log(multiverappupdates);
