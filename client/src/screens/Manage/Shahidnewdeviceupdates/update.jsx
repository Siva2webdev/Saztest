...
const Update10 = () => {
  ...
  const [shahidnewdeviceupdates, setShahidnewdeviceupdates] = useState([]);
  useEffect(() => {
    fetch("http://localhost:5001/api/shahid_new_app_updates/find")
      .then((response) => response.json())
      .then((json) => setShahidnewdeviceupdates(json.data));
  }, []);
  console.log(shahidnewdeviceupdates);
